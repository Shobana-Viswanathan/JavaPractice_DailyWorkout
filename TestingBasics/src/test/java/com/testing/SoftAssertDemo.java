...
public class SoftAssertDemo {
  ...
  public void validation() {
	...
	driver.findElement(By.id("loginusername")).sendKeys("Shobs");
	driver.findElement(By.id("loginpassword")).sendKeys("shobi11");
  ...
  public void invalidusername() {
	  driver.findElement(By.id("login2")).click();
	driver.findElement(By.id("loginusername")).sendKeys("Shob");
	driver.findElement(By.id("loginpassword")).sendKeys("shobi11");
	driver.findElement(By.xpath("//button[@onclick='logIn()']")).click();
	WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(15));
  ...
  public void invalidpassword() {
	  driver.findElement(By.id("login2")).click();
	driver.findElement(By.id("loginusername")).sendKeys("Shobs");
	driver.findElement(By.id("loginpassword")).sendKeys("shobi1");
	driver.findElement(By.xpath("//button[@onclick='logIn()']")).click();
	WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(15));
	wait.until(ExpectedConditions.alertIsPresent());
	Alert alert=driver.switchTo().alert();
